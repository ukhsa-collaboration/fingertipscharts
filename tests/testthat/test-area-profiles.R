...
full_with_domains_p <- suppressWarnings(
        area_profiles(df,
                      value = Value,
                      count = Count,
                      area_code = AreaCode,
...
full_all_dividers_p <- suppressWarnings(
        area_profiles(df,
                      value = Value,
                      count = Count,
                      area_code = AreaCode,
...
dps_p <- suppressWarnings(
        area_profiles(df_dps,
                      value = Value,
                      count = Count,
                      area_code = AreaCode,
                      local_area_code = "AC122",
