...
dfdom <- fingertips_data(DomainID = 1938132983) %>%
...
```{r overview, out.width='100%', fig.width=12, fig.height=4, fig.align='center', warning=FALSE}
...
dfspine <- fingertips_data(DomainID = 1938132983, rank = TRUE) %>%
        filter(Timeperiod == "2015",
               Sex == "Persons")
```
...
p <- area_profiles(dfspine,
                   ...
                   datatable = TRUE,
                   header_positions = c(-1.6, -0.63, -0.48, -0.36, -0.21, -0.05, 1.08),
